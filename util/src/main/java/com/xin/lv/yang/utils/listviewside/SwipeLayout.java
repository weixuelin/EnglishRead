...
public class SwipeLayout extends FrameLayout {
     ...
     * 初始化
     *
     * @param contentView 主显示的view
     * @param menuView    侧滑菜单的view
     */

    public SwipeLayout(View contentView, SwipeView menuView) {
        this(contentView, menuView, null, null);
    }

    public SwipeLayout(View contentView, SwipeView menuView, Interpolator closeInterpolator, Interpolator openInterpolator) {

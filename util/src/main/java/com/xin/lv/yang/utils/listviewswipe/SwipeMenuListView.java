...
public class SwipeMenuListView extends ListView {
    ...
    private SwipeListViewMenuCreator mMenuCreator;
    ...
    public void setAdapter(ListAdapter adapter) {
        super.setAdapter(new SwipeListViewMenuAdapter(getContext(), adapter) {
            @Override
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        // 在拦截处处理，在滑动设置了点击事件的地方也能swip侧滑，点击时又不能影响原来的点击事件
    ...
    public void setMenuCreator(SwipeListViewMenuCreator menuCreator) {
    ...
    public interface OnMenuItemClickListener {
        boolean onMenuItemClick(int position, SwipeListViewMenu menu, int index);
    }

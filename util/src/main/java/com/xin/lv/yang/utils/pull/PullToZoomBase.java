    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        if (attrs != null) {
           ...
           /// 头部的 view
            ...
            /// 尾部的View
            int footResId = a.getResourceId(R.styleable.PullToZoomView_footView, 0);
            if (footResId > 0) {
                mFootView = mLayoutInflater.inflate(footResId, null, false);
            }

 ...
 * 汉字转换成拼音
 */
public class HanZiToSpell {

    private static final String TAG = "HanZiToSpell";
    private static final boolean DEBUG = false;
    public static final char[] UNIHANS = new char[]{
            '阿', '哎', '安', '肮', '凹', '八', '挀', '扳', '邦', '勹',
            '陂', '奔', '伻', '屄', '边', '灬', '憋', '汃', '冫', '癶',
            '峬', '嚓', '偲', '参', '仓', '撡', '冊', '嵾', '曽', '曾',
            '層', '叉', '芆', '辿', '伥', '抄', '车', '抻', '沈', '沉',
            ...
            '隹', '宒', '卓', '乲', '宗', '邹', '租', '钻', '厜', '尊',
            '昨', '兙', '鿃', '鿄'};
    public static final byte[][] PINYINS = new byte[][]{
    ...
    private static HanZiToSpell sInstance;
    private final boolean mHasChinaCollator;

    protected HanZiToSpell(boolean var1) {
        this.mHasChinaCollator = var1;
    }

    public static HanZiToSpell getInstance() {
        Class var0 = HanZiToSpell.class;
        synchronized (HanZiToSpell.class) {
            if (sInstance != null) {
                return sInstance;
            } else {
                ...
                for (int var4 = 0; var4 < var3; ++var4) {
                    ...
                    if (var5.equals(Locale.CHINA) || var5.getLanguage().equals("zh") && var5.getCountry().equals("HANS")) {
                        sInstance = new HanZiToSpell(true);
                        return sInstance;
                    }
                }

                Log.w("HanZiToSpell", "There is no Chinese collator, HanZiToSpell is disabled");
                sInstance = new HanZiToSpell(true);
                return sInstance;
            }
        }
    ...
    private static boolean doSelfValidation() {
        ...
        for (int var4 = 0; var4 < var3; ++var4) {
            ...
            if (var0 != var5) {
                ...
                if (var7 >= 0) {
                    Log.e("HanZiToSpell", "Internal error in Unihan table. The last string \"" + var1 + "\" is greater than current string \"" + var6 + "\".");
                    return false;
                }
    ...
    private HanZiToSpell.Token getToken(char var1) {
        HanZiToSpell.Token var2 = new HanZiToSpell.Token();
    ...
    public ArrayList<HanZiToSpell.Token> get(String var1) {
        ...
        if (this.mHasChinaCollator && !TextUtils.isEmpty(var1)) {
            ...
            for (int var6 = 0; var6 < var3; ++var6) {
                ...
                if (var7 == 32) {
                    ...
                    HanZiToSpell.Token var8 = this.getToken(var7);
                    if (var8.type == 2) {
                        if (var4.length() > 0) {
                            this.addToken(var4, var2, var5);
                        }
    ...
    private void addToken(StringBuilder var1, ArrayList<HanZiToSpell.Token> var2, int var3) {
        String var4 = var1.toString();
        var2.add(new HanZiToSpell.Token(var3, var4, var4));
        var1.setLength(0);
    }

package com.xin.lv.yang.utils.video.fragment;
...
import com.xin.lv.yang.utils.video.ImageCache;
import com.xin.lv.yang.utils.video.ImageResizer;
import com.xin.lv.yang.utils.video.RecyclingImageView;
import com.xin.lv.yang.utils.video.VideoEntity;

import java.io.File;
import java.util.ArrayList;
import java.util.List;

public class ImageGridFragment extends Fragment implements OnItemClickListener, AdapterView.OnItemLongClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ImageView imageView = v.findViewById(R.id.image_back);
    ...
    public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
        if (i > 0) {
            Log.i("wwwwww", "长按的位置====" + i);
            final VideoEntity vEntty = mList.get(i - 1);
            AlertDialog.Builder builder = new AlertDialog.Builder(getActivity());
            builder.setMessage("是否播放该视频？")
                    .setPositiveButton("播放", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialogInterface, int i) {
                            Intent intent = new Intent(Intent.ACTION_VIEW);
                            intent.setDataAndType(Uri.fromFile(new File(vEntty.filePath)), "video/mp4");
    ...
    private class ImageAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup container) {
            ...
            if (position == 0) {
                ...
                holder.tvSize.setGravity(Gravity.CENTER_HORIZONTAL);
                ...
                holder.tvDur.setText(BitmapUtil.toTime(entty.duration));
                holder.tvSize.setText(TextUtils.getDataSize(entty.size));

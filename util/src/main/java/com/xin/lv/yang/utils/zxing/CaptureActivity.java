...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback, OnZxing {
    ...
    private void initCamera(SurfaceHolder surfaceHolder) {
        ...
        try {
            ...
            // RuntimeException.
            if (handler == null) {
                handler = new CaptureActivityHandler(this, cameraManager, this, DecodeThread.ALL_MODE);
            }
    ...
    private void initCrop() {
        ...
        Log.i("result", "xxx==" + x + "-----yyy=" + y + "----www=" + width + "----hhh=" + height);

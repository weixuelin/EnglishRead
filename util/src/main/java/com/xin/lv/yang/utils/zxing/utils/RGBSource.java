...
public class RGBSource extends LuminanceSource {

    private final byte[] luminances;

    public  RGBSource(Bitmap bitmap){
    ...
    protected RGBSource(int width, int height, byte[] luminances) {
        super(width, height);
    ...
    public RGBSource(String path) throws FileNotFoundException {
